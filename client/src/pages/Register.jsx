    ...
    <div className="min-h-screen bg-gradient-to-br from-pink-50 to-purple-50 flex items-center justify-center py-12 px-4">
      <div className="max-w-md w-full">
        ...
        <div className="bg-white rounded-2xl shadow-xl p-8">
          <h2 className="text-2xl font-bold text-gray-900 mb-2">Join Our Beauty Community</h2>
          <p className="text-gray-600 mb-8">Create your account to start shopping</p>
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
            ...
            <div>
              ...
              {emailAvailable === false && (
                <p className="mt-1 text-sm text-red-600">
                  Email is already registered. <Link to="/login" className="text-pink-600 hover:underline">Login instead?</Link>
                </p>
              )}
              {emailAvailable === true && (
            ...
            <button
              type="submit"
              disabled={loading || checkingEmail || emailAvailable !== true}
              className="w-full bg-gradient-to-r from-pink-500 to-purple-600 hover:from-pink-600 hover:to-purple-700 text-white py-3 px-4 rounded-lg font-semibold transition-all duration-200 disabled:opacity-50 disabled:cursor-not-allowed"
            >
        ...
        <div className="mt-8 text-center text-sm text-gray-500">
          <p>
            ...
            and{' '}
            <Link to="/cookies" className="underline hover:text-gray-700">
              Cookie Policy
            </Link>
            .
          </p>
